...
echo ""
echo "Next steps:"
echo "1. Build AILive with GPU: ENABLE_GPU=true ./gradlew assembleDebug"
...
echo ""
echo "Note: Set ENABLE_GPU=true to enable OpenCL GPU acceleration"
echo "      Omit ENABLE_GPU to build CPU-only version (works without this setup)"
echo ""
